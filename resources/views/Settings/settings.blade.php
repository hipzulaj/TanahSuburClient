                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="list-group">
                                    <a href="{{url('settings/listsensor')}}" class="list-group-item list-group-item-action">Daftar Sensor</a>
                                    <a href="{{url('settings/listtanaman')}}" class="list-group-item list-group-item-action">Daftar Tanaman</a>
                                    <a href="{{url('settings/tanaman/ubahtanaman')}}" class="list-group-item list-group-item-action">Ubah Indikator Yang digunakan</a>
                                    @if(Session::get('role')=='admin')
                                    <a href="{{url('settings/usermanagement/listuser')}}" class="list-group-item list-group-item-action">Daftar User</a>
                                    @endif
                                </div>
                            </div>
                        </div>
