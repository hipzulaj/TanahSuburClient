...
<head>
    ...
    <title>Tanah Subur - Edit Sensor</title>
                ...
                <div class="col-12 mt-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{{url('settings/atursensor/editsensor/submit'.'/'.$sensor[0]['id'])}}}" method="post">
                              {{ csrf_field() }}
                                <div class="form-group">
                                    <label for="disabledTextInput">Nama Sensor</label>
                                    <input type="text" id="example-text-input" class="form-control" name="nama_alat" value="{{$sensor['0']['nama_alat']}}">
                                </div>
                                <div class="form-group">
                                    <label for="disabledTextInput">IP Address</label>
                                    <input type="text" id="example-text-input" class="form-control" name="ip_address" value="{{$sensor['0']['ip_address']}}">
                                </div>
                                <fieldset disabled="">
                                <div class="form-group">
                                    <label for="disabledTextInput">Indikator Tanaman Terpilih</label>
                                    <input type="text" id="disabledTextInput" class="form-control" placeholder="{{$sensor[0]['nama_tanaman']}}">
                                </div>
                                </fieldset>
                                <div class="form-group">
